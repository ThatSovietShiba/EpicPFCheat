            ...
            for i = 1, #playerlist do
                if(user.Name == playerlist[i]) then
                    ...
                    if(_G.Kick == false) and (_G.Notify == true) then
                        ...
                        Library:Notify('A Risky Player Joined:'..playerlist[i].." at: "..Time.hour..":"..Time.min.."", 7)    
